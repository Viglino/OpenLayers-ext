...
*/
/** 
 * Function: OpenLayers.bouncingMarker
 * Animate a point feature width drop and bounce effect.
 * 
 * Parameters:
 *	feature - {Feature} the feature to animate
 *	options
 *	{	mode <enum> bounce | shake | drop | fall | slide | slip | throw
 ...
 *	}
 */
OpenLayers.bouncingMarker = function (feature, options)
{	if (!options) options = {};
